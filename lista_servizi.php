                                        ...
                                        <tbody>
										    <?php
												foreach ($servizi as $a) {
													...
													echo '<td class=" ">
                            <a href="dettagli_servizio.php?id_assistito='.$a["id_assistito"].'&id_servizio_erogato='.$a["id_servizio_erogato"].'" title="Dettagli servizio"><span class="glyphicon glyphicon-assistiti-actions glyphicon-file" aria-hidden="true"></span></a>&nbsp;
